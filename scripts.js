...
/**
 * Importing functions and variables from the view.js module
 * @typedef {import('./view.js').html} html - Object lietral that contains reference to all html elements used in the application
 * @typedef {import('./view.js').createOrderHtml} createElement
 * @typedef {import('./view.js').updateDraggingHtml} updateDraggingHtml
 * @typedef {import('./view.js'.moveToColumn)} moveToColumn
 */
